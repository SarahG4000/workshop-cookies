...
<body>
    <div id="app">
        ...
        <p><button href="javascript:createCookie('cookietest1')" class="page">Créer cookie 1</button><br>
        <button href="javascript:readCookie('cookietest1')" class="page">Lire cookie 1</button><br>
        <button href="javascript:eraseCookie('cookietest1')" class="page">Supprimer cookie 1</button></p>
